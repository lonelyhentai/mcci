...
import com.evernightfireworks.mcci.services.dtos.CCategoryDto;
import com.evernightfireworks.mcci.services.dtos.CGraphDto;
import com.evernightfireworks.mcci.services.dtos.CLinkDto;
import com.evernightfireworks.mcci.services.dtos.CNodeDto;
...
public class CGraph {
    ...
    public boolean isEmpty() {
        return this.target==null && nodes.isEmpty();
    }

    public boolean shouldUpdate(Item item) {
    ...
    public String serialize(BiFunction<CGraph, CNode, Integer> symbolSizeCalculator) {
        ...
        ArrayList<CNodeDto> nodes = this.nodes.values().stream()
                .map((n) -> {
                    ...
                    var res = new CNodeDto(nodeCounter.count, translation, n.kind.ordinal(),
                            symbolSizeCalculator.apply(this, n));
                    nodeCounter.count += 1;
                    return res;
                })
