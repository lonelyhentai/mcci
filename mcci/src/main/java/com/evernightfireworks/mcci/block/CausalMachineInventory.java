...
@FunctionalInterface
public interface CausalMachineInventory extends SidedInventory {

    DefaultedList<ItemStack> getItems();
    /**
     * Creates an inventory from the item list.
     */
    static CausalMachineInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
    /**
     * Creates a new inventory with the size.
     */
    static CausalMachineInventory ofSize(int size) {
